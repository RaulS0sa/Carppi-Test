...
{
    public class CarppiRestaurantRequestApiController : ApiController
    {
        ...
        [HttpGet]
        public HttpResponseMessage EditProductDetails(string RestaurantWhoWahtToEditItsProduct, int ProductIndex, int ProductCategory, double CostTotal, string nombre, string descriptcion)
        {
            //(int ProductCategory, double CostTotal, string nombre, string descriptcion, string restaurante)
            var Reataurante = db.Carppi_IndicesdeRestaurantes.Where(x => x.CarppiHash == RestaurantWhoWahtToEditItsProduct).FirstOrDefault();
            if (Reataurante != null)
            {
                var Producto = db.Carppi_ProductosPorRestaurantes.Where(x => x.IDdRestaurante == RestaurantWhoWahtToEditItsProduct && x.ID == ProductIndex).FirstOrDefault();
                if (Producto != null)
                {
                    Producto.Categoria = ProductCategory;
                    Producto.Costo = CostTotal;
                    Producto.Nombre = nombre;
                    Producto.Descripcion = descriptcion;
        ...
        [HttpGet]
        public HttpResponseMessage DownloadProductDetails(string RestaurantWhoWahtToEditItsProduct, int ProductIndex)
        {
            var Reataurante = db.Carppi_IndicesdeRestaurantes.Where(x => x.CarppiHash == RestaurantWhoWahtToEditItsProduct).FirstOrDefault();
            if(Reataurante != null)
            {
        ...
        [HttpGet]
        public HttpResponseMessage TransferToAcoount(string ServiceProviderToTransferHash, IndexOfConnectedAccount TypeOfAcoount )
        {
            try
            {
        ...
        [HttpGet]
        public HttpResponseMessage GetDebtData(string DebtorHash, IndexOfConnectedAccount DebtorType)
        {
            try
            {
...
//                db.SaveChanges();
        ...
        [HttpGet]
        public HttpResponseMessage GenerateValidationCodeForStripeValidation(string ServiceProviderHash, IndexOfConnectedAccount serviceProvider)
        {
            try
            {
                var Rnd = new Random();
                var RndNmbr = (int)((Rnd.NextDouble() * (999999 - 100000)) + 100000);
                if (serviceProvider == IndexOfConnectedAccount.Restaurant)
                {
                    var Reataurante = db.Carppi_IndicesdeRestaurantes.Where(x => x.CarppiHash == ServiceProviderHash).FirstOrDefault();
                    if (Reataurante != null)
                    {
                ...
                else if (serviceProvider == IndexOfConnectedAccount.DeliveryMan)
                {
                    var Repartidor = db.CarppiGrocery_Repartidores.Where(x => x.FaceID_Repartidor == ServiceProviderHash).FirstOrDefault();
                    if (Repartidor != null)
                    {
                        Repartidor.ValidationCode = RndNmbr.ToString();
                        Push_Repartidor("Codigo de validacion", "Clave " + RndNmbr.ToString(), Repartidor.FirebaseID, "");
                    }
        ...
        public HttpResponseMessage ValidateServiceVoce(string ServiceProviderCodeHash, string CodeToValidate, IndexOfConnectedAccount serviceProvider)
        {
            try
            {
                if (serviceProvider == IndexOfConnectedAccount.Restaurant)
                {
                    var Reataurante = db.Carppi_IndicesdeRestaurantes.Where(x => x.CarppiHash == ServiceProviderCodeHash).FirstOrDefault();
                    if (Reataurante != null)
                    {
                       if(Reataurante.contextualVailidationNumber.ToString() == CodeToValidate)
                        {
                            return new HttpResponseMessage(HttpStatusCode.OK);
                        }
                        else
                ...
                {
                    var Repartidor = db.CarppiGrocery_Repartidores.Where(x => x.FaceID_Repartidor == ServiceProviderCodeHash).FirstOrDefault();
                    if (Repartidor != null)
                    {
                        if (Repartidor.FleetManagerHash == null)
                        {
                           // Repartidor.StripeHash = StripeComercianteID;

                            if (Repartidor.ValidationCode == CodeToValidate)
                            {
                                return new HttpResponseMessage(HttpStatusCode.OK);
                            }
                            else
        ...
        public HttpResponseMessage UpdateStripeServiceProviderID(string ServiceProviderHash, string StripeComercianteID, IndexOfConnectedAccount serviceProvider)
        {
            try
            {
                if (serviceProvider == IndexOfConnectedAccount.Restaurant)
                {
                    ...
                    if (Reataurante != null)
                    {
                        Reataurante.StripeHash = StripeComercianteID;
        ...
        public HttpResponseMessage PostMessageInRestauranClient(String FaceID_speaker, Int64 shopRequest, String Message)
        {
        ...
        [HttpGet]
        [ActionName("ApiByAction")]  
        public HttpResponseMessage GetAlMessagesFromConversationRestauranClient(String FaceID_Interest, Int64 shopRequest)
        {
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage PostMessageInRestauranDeliver(String FaceID_speaker, string DeliverRequest, String Message)
        {
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage GetAlMessagesFromConversationRestauranDeliver(String FaceID_Interest, string DeliverRequest)
        {
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage ExtraDataDeliverManView(string restaurantHashRequestingExtraDataDeliver, string Deliverman)
        {
            var Ordenes = db.CarppiRestaurant_BuyOrders.Where(x => x.RestaurantHash == restaurantHashRequestingExtraDataDeliver && x.FaceIDRepartidor_RepartidorCadena == Deliverman);
            List<ExtradataDeliveryMan> extradataDeliveryMen = new List<ExtradataDeliveryMan>();
            foreach (var orden in Ordenes)
            {

                ExtradataDeliveryMan extradataDelivery = new ExtradataDeliveryMan();
                extradataDelivery.Orden = orden.ID.ToString();
                var cadenadeOrdenes = Base64Decode(orden.ListaDeProductos);
                ...
                extradataDelivery.ListaDeProductos = datas;
                extradataDeliveryMen.Add(extradataDelivery);
            }
            return Request.CreateResponse(HttpStatusCode.OK, extradataDeliveryMen);

        }
        class ExtradataDeliveryMan 
        {
            public string Orden;
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage ExtraDataVispatchDeliverMan(string restaurantHashDispatchDeliveryMan, string Deliverman)
        {
            var Ordenes = db.CarppiRestaurant_BuyOrders.Where(x => x.RestaurantHash == restaurantHashDispatchDeliveryMan && x.FaceIDRepartidor_RepartidorCadena == Deliverman);
            var Order = Ordenes.FirstOrDefault();
            var Repartidor = db.CarppiGrocery_Repartidores.Where(x => x.FaceID_Repartidor == Deliverman).FirstOrDefault();
            ...
            if (IsDriverInRegion)
            {
                foreach (var orden in Ordenes)
                {
                    ...
                    orden.Stat = (int)GroceryOrderState.RequestGoingToClient;
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage RestaurantToSetItsAvailabitity(string RestaurantHashToopen, ItemAvailability Available)
        {
            if (Available == ItemAvailability.SetUnavailable)
            {
                var Reataurante = db.Carppi_IndicesdeRestaurantes.Where(x => x.CarppiHash == RestaurantHashToopen ).FirstOrDefault();
                Reataurante.EstaAbierto = false;
                db.SaveChanges();
                return Request.CreateResponse(HttpStatusCode.OK, "");
            }
            else
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage SetOrderStatus( GroceryOrderState Estado, Int32 OrderID)
        {
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage RestaurantDeliveryManAssigned(string RestaurantHashDeliveryMan)
        {
        ...
        */
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage RestaurantToSetItsItemAvailable(string RestaurantHashDownloadMenu, long itemID, ItemAvailability Available)
        {
            if (Available == ItemAvailability.SetUnavailable)
            {
                var Items = db.Carppi_ProductosPorRestaurantes.Where(x => x.IDdRestaurante == RestaurantHashDownloadMenu && x.ID == itemID).FirstOrDefault();
                Items.Disponibilidad = false;
                db.SaveChanges();
            ...
            {
                var Items = db.Carppi_ProductosPorRestaurantes.Where(x => x.IDdRestaurante == RestaurantHashDownloadMenu && x.ID == itemID).FirstOrDefault();
                Items.Disponibilidad = true;
                db.SaveChanges();
                return Request.CreateResponse(HttpStatusCode.Accepted, Items);
            }
            return Request.CreateResponse(HttpStatusCode.BadRequest, "");
        }
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage RestaurantToDownloadItsOwnState(string RestaurantHashDownloadOpenState)
        {
            var Items = db.Carppi_IndicesdeRestaurantes.Where(x => x.CarppiHash == RestaurantHashDownloadOpenState).FirstOrDefault();
            return Request.CreateResponse(HttpStatusCode.OK, Items.EstaAbierto);
        }


        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage RestaurantToDownloadItsOwnMenu(string RestaurantHashDownloadMenu)
        {
            var Items = db.Carppi_ProductosPorRestaurantes.Where(x => x.IDdRestaurante == RestaurantHashDownloadMenu);
            return Request.CreateResponse(HttpStatusCode.OK, Items);
        }

        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage RestaurantToDownloadItsOwnMenuIDs(string RestaurantHashDownloadMenu_IDList)
        {
        ...
        [HttpGet]
        [ActionName("ApiByAction")]
        public HttpResponseMessage CarppiPendingRequest(string RestaurantHash)
