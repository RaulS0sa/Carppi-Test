...
{
    public class FragmentTransfer : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var Template = "MyFinancials.html";
            ...
            using (StreamReader sr = new StreamReader(assets.Open(Template)))
            {
                ...
                // webi.LoadData(content, "text/html", null);
                  webi.SetWebViewClient(new TransferClientWebClient(webi));
        ...
        {
            var frag1 = new FragmentTransfer { Arguments = new Bundle() };
            return frag1;
        }
    }

    public class TransferClientWebClient : WebViewClient
    {

        protected WebView webView;
        public TransferClientWebClient(WebView wk)
        {
            webView = wk;
        }
        ...
        public override void OnPageFinished(WebView view, string url)
        {
            ...
            try
            {
                ...
                var uri = new Uri(string.Format("https://geolocale.azurewebsites.net/api/CarppiRestaurantRequestApi/GetDebtData?" +
                    "DebtorHash=" + HAsh
                    + "&DebtorType=" + ((int)FragmentTransfer.IndexOfConnectedAccount.Restaurant).ToString()
                    ));
                ...
                if (S_Ressult.httpStatusCode == System.Net.HttpStatusCode.OK)
                {
                  ...
                  //  var Response = JsonConvert.DeserializeObject<bool?>(S_Ressult.Response);
                    Action action = () =>
                    {
                        ...
                        var script = "UpdateTags(" + S_Ressult.Response + ")";
