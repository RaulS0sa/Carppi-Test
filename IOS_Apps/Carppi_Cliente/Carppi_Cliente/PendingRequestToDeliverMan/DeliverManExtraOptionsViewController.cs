...
namespace Carppi_Cliente.PendingRequestToDeliverMan
{
    public partial class DeliverManExtraOptionsViewController : UIViewController
    {
        public DeliverManExtraOptionsViewController() : base("DeliverManExtraOptionsViewController", null)
        {
        }
        ...
        {
            base.ViewDidLoad();
               var fileName1 = "Views/DelivermanExtraData.html";
